...
<div class="form-group row">
    <div class="col-sm-4">
        <?php echo e(Form::label('Ünvanı', null, ['class' => 'font-weight-bold'])); ?>

    </div>
    <div class="col-sm-8">
        <?php echo e(Form::text('name', $item->name ?? null, ['class' => 'form-control', 'placeholder' => 'Tüzel Kişi - Ünvanı Yazınız', 'required' => ''])); ?>

    </div>
</div>
<div class="form-group row">
    <div class="col-sm-4">
        <?php echo e(Form::label('Detsis Numarası', null, ['class' => 'font-weight-bold'])); ?>

    </div>
    <div class="col-sm-8">
        <?php echo e(Form::text('detsis_number', $item->detsis_number ?? null, ['class' => 'form-control detsismask', 'placeholder' => 'Detsis No Yazınız'])); ?>

        <label class="kt-checkbox">
            <?php echo e(Form::checkbox('check[detsis]', true, isset($item) ? GlobalFunction::checkControl('detsis', $item->check) : false)); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?php echo e(Form::select('tax_office', App\Models\TaxOffice::selectToArray(), $item->tax_office_id ?? 'default', ['class' => 'form-control selectSearch', 'placeholder' => '--Seçiniz--', 'data-live-search' => 'true'])); ?>

    </div>
</div>
<div class="form-group row">
    <div class="col-sm-4">
        <?php echo e(Form::label('Vergi Numarası', null, ['class' => 'font-weight-bold'])); ?>

    </div>
    <div class="col-sm-8">
        <?php echo e(Form::text('tax_number', $item->tax_number ?? null, ['class' => 'form-control taxmask', 'placeholder' => 'Vergi No Yazınız'])); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?php echo e(Form::text('phone', $item->phone ?? null, ['class' => 'form-control phonemask', 'placeholder' => 'GSM Numarası Yazınız'])); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?php echo e(Form::text('fixed_phone', $item->fixed_phone ?? null, ['class' => 'form-control phonemask', 'placeholder' => 'Sabit Telefon Numarası Yazınız'])); ?>
...
<?php /**PATH C:\laragon\www\arbsys\resources\views/mediator/person/modals/company_public.blade.php ENDPATH**/ ?>