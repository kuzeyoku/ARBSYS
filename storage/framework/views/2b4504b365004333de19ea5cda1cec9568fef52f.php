...
<body>
    ...
    <header class="header">
        ...
        <div class="logos">
            <img width="65" src="<?php echo e(asset('images/landing_page/logo.png')); ?>" alt="">
            <a href="<?php echo e(route('frontend.index')); ?>" data-aos="zoom-in-left" data-aos-delay="150" class="logo">
                <span>ARBSYS</span>
            </a>
        </div>
        <nav class="navbar">
        ...
        <?php if(auth()->guard()->guest()): ?>
            <div>
                <a href="<?php echo e(route('login')); ?>" class="btn">üye girişi</a>
                <a href="<?php echo e(route('register')); ?>" class="btn">Kayıt Ol</a>
            </div>
        <?php else: ?>
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin')): ?>
                <a href="<?php echo e(route('admin.home')); ?>" class="btn">Yönetim Paneli</a>
            <?php elseif (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check("mediator")): ?>
                <a href="<?php echo e(route('home')); ?>" class="btn">Hesabım</a>
            <?php endif; ?>
        <?php endif; ?>
    </header>
    ...
    <section class="about" id="about">
        <div class="video-container" data-aos="fade-right" data-aos-delay="300">
            <video src="<?php echo e(asset('images/landing_page/about.mp4')); ?>" muted autoplay loop class="video"></video>
        </div>
            ...
            <ul class="pricingTable-content">
                <li class="pricingTable-item">
                    ...
                    <ul class="pricingTable-options">
                        <li> <img src="<?php echo e(asset('images/landing_page/check.svg')); ?>" alt=""> Önce 14 gün
                            ücretsiz
                            deneyin!</li>
                        <li> <img src="<?php echo e(asset('images/landing_page/check.svg')); ?>" alt=""> Kalan günler
                            için
                            diğer
                ...
                <li class="pricingTable-item">
                    ...
                    <ul class="pricingTable-options">
                        <li> <img src="<?php echo e(asset('images/landing_page/check.svg')); ?>" alt=""> 348₺ + KDV
                            olarak
                            yıllık
                            faturalandırılır</li>
                        <li> <img src="<?php echo e(asset('images/landing_page/check.svg')); ?>" alt=""> Aylık aboneliğe
                            göre 120₺
                            daha hesaplı</li>
                    </ul>
                    <button class="pricingTable-btn">Hemen Satın Al</button>
                ...
                <li class="pricingTable-item">
                    ...
                    <ul class="pricingTable-options">
                        <li> <img src="<?php echo e(asset('images/landing_page/check.svg')); ?>" alt=""> Her ay
                            faturalandırılır
                        </li>
                        <li> <img src="<?php echo e(asset('images/landing_page/check.svg')); ?>" alt=""> Dilediğinizde
                            yıllık
        ...
        <div class="box-container">
            <div class="box">
                <p>“I'm a testimonial. Click to edit me and add text that says something nice about you and your
                    services.״</p>
                <div class="user">
                    <img src="<?php echo e(asset('images/landing_page/pic-1.png')); ?>" alt="">
                    <div class="info">
                        <h3>Jen B.</h3>
                        <span>Milestone</span>
                    </div>
    ...
    <section class="reference">
        <div class="box-container">
            <div class="box">
                <img src="<?php echo e(asset('images/landing_page/references.webp')); ?>" alt="">
            </div>
            <div class="box">
                <img src="<?php echo e(asset('images/landing_page/references.webp')); ?>" alt="">
            </div>
    ...
    <section class="footer">
        ...
        <div class="bottom">
            <img src="<?php echo e(asset('assets/visa-mastercard.png')); ?>" alt="">
        </div>
    </section>

    <!-- Footer end -->
    <!-- custom js file link  -->
    <script src="<?php echo e(asset('js/page/landing_page/script.js')); ?>" defer></script>
...
<?php /**PATH C:\laragon\www\arbsys\resources\views/frontend/index.blade.php ENDPATH**/ ?>