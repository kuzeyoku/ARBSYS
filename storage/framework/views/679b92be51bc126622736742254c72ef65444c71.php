...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?php echo e(Form::text('identification', isset($item) ? $item->identification : null, ['class' => 'form-control tcmask', 'placeholder' => 'T.C. Kimlik No Yazınız'])); ?>

        <label class="kt-checkbox">
            <?php echo e(Form::checkbox('check[foreign]', true, isset($item) ? GlobalFunction::checkControl('foreign', $item->check) : null)); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        ...
        <label class="kt-checkbox">
            <?php echo e(Form::checkbox('check[phone]', true, isset($item) ? GlobalFunction::checkControl('phone', $item->check) : null)); ?>
...
<?php /**PATH C:\laragon\www\arbsys\resources\views/mediator/person/modals/person_standard.blade.php ENDPATH**/ ?>