...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?php echo e(Form::select('tax_office', App\Models\TaxOffice::selectToArray(), $item->tax_office_id ?? 'default', ['class' => 'form-control selectSearch', 'placeholder' => '--Seçiniz--'])); ?>
...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        <?php echo Form::text('email', $item->email ?? null, [
...
<?php /**PATH C:\laragon\www\arbsys\resources\views/mediator/person/modals/person_taxpayer.blade.php ENDPATH**/ ?>