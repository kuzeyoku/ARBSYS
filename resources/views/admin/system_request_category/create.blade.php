                ...
                <div class="kt-subheader__main">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mt-1" style="background-color: white;">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Görüş ve Öneri Kategorileri Oluştur</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        <form class="kt-form kt-form--label-right" action="/system_request_category" method="post">
                            @csrf
