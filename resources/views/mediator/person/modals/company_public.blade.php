...
<div class="form-group row">
    ...
    <div class="col-sm-8">
        ...
        @else
            {{ Form::select('type', App\Models\PersonType::selectToArray(), $item->personType->key, ['class' => 'form-control', 'placeholder' => '--Seçiniz--', 'data-url' => route('api.get_person_modal_content')]) }}
        @endif
    </div>
</div>
<div class="form-group row">
