            ...
            if (wizard.getStep() === 3) {
                ...
                if ($("select[name='mediation_office_id']").val() !== "") {
                    html +=
                        ...
                        $("select[name='mediation_office_id'] option:selected").text() +
                        "</p>";
                }
                if ($("select[name='mediation_center_id']").val() !== "") {
                    html +=
                        "<p><strong>Arabuluculuk Merkezi : </strong>" +
                        $("select[name='mediation_center_id'] option:selected").text() +
                        "</p>";
                }
                if ($("select[name='lawsuit_subject_type_id']").val() !== "") {
                    html +=
                        "<p><strong>Uyuşmazlık Türü : </strong>" +
                        $("select[name='lawsuit_subject_type_id'] option:selected").text() +
                        "</p>";
                }
                if ($("select[name='lawsuit_subject_id']").val() !== "") {
                    html +=
                        "<p><strong>Uyuşmazlık Konusu : </strong>" +
                        $("select[name='lawsuit_subject_id'] option:selected").text() +
                        "</p>";
                }
